    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Administrador'), ('RESIDENCIAL', 'Usuário Residencial'), ('EMPRESA', 'Empresa Parceira'), ('INSTITUICAO', 'Instituição Ambiental')], default='RESIDENCIAL', max_length=20)),
